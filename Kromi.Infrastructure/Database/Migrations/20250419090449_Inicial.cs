        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ficha = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    BloqueadoEl = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenericStringString", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "PreguntaSeguridadUsuarios",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UsuarioId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: true),
                    PreguntaSeguridadId = table.Column<long>(type: "bigint", nullable: true),
                    EstaActivo = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreguntaSeguridadUsuarios", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreguntaSeguridadUsuarios_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PreguntaSeguridadUsuarios_PreguntasSeguridad_PreguntaSeguridadId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreguntaSeguridadUsuarios_PreguntaSeguridadId",
                table: "PreguntaSeguridadUsuarios",
                column: "PreguntaSeguridadId");

            migrationBuilder.CreateIndex(
                name: "IX_PreguntaSeguridadUsuarios_UsuarioId",
                table: "PreguntaSeguridadUsuarios",
                column: "UsuarioId");
